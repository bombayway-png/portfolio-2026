...
// Define the steps of our funnel
...
export default function Home() {
  ...
  // Note: 'a1', 'a2', etc. correspond to custom questions in your Calendly dashboard
  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 font-sans selection:bg-blue-100 overflow-x-hidden">
      ...
      <main className="max-w-7xl mx-auto px-6 md:px-12 pt-32 md:pt-48 pb-24">
        {/* --- Hero Section --- */}
        <section className="flex flex-col md:flex-row gap-12 md:gap-16 items-center mb-16 md:mb-24 text-center md:text-left text-slate-900">
          <div className="flex-1 order-2 md:order-1">
            ...
            <p className="text-lg md:text-2xl text-slate-500 max-w-3xl font-medium italic mb-10 leading-relaxed mx-auto md:mx-0">
              Bridging the gap between Enterprise Strategy and Code. Leveraging 10+ years at <strong>Amazon, AWS, and Microsoft</strong> to build autonomous frameworks.
            </p>
        ...
        {/* --- Triad & Pillars (Code omitted for brevity, remains identical) --- */}
      </main>
              ...
              {activeFilter === 'intake' ? (
                <div className="text-slate-900">
                  ...
                  <form className="space-y-8 md:space-y-12">
                     ...
                     <div className="space-y-3">
                        <label className="text-[10px] md:text-xs font-black uppercase tracking-widest text-blue-600">Bottleneck Description</label>
                ...
                <motion.div initial={{ scale: 0.95, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} className="text-left space-y-12">
                  ...
                  <div className="bg-slate-900 text-white p-8 md:p-12 rounded-[3rem] shadow-2xl border-4 border-blue-600 relative overflow-hidden">
                    ...
                    <div className="space-y-8 relative z-10">
                      ...
                      <div className="pt-6 border-t border-slate-800 flex items-center gap-2 text-blue-400 font-bold italic">
                        <Zap size={18} /> Memory Mapped: Ready for Sync
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-6">
                    ...
                    <p className="text-lg text-slate-500 italic font-medium">By approving, this briefing data will be injected into your discovery session invitation.</p>
...
// ... TriadCard and ServicePillarSection helper functions remain identical ...
